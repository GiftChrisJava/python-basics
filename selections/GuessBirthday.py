...
#prompt user to answer the first question
...
#prompt user to answer the second question
...
#prompt user to answer the third question
...
#prompt user to answer the fourth question
